...
for puf_instance = 1:number_of_pufs_under_test
    ...
    for j=1:number_of_CRPs_per_puf
        ...
        r_init = loop_xor_response(delta,c_init);
        for k = 1:50
            ...
            for hd=1:stages  
                ...
                r_new = loop_xor_response(delta,c_new);
...
final = count_same ./(number_of_CRPs_per_puf*number_of_pufs_under_test*50); 
